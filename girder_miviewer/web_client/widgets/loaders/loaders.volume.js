...
import LoadersBase from 'ami.js/src/loaders/loaders.base.js';
import ModelsSeries from 'ami.js/src/models/models.series.js';
import ModelsFrame from 'ami.js/src/models/models.frame.js';
import ParsersDicom from 'ami.js/src/parsers/parsers.dicom.js';
import ParsersMhd from 'ami.js/src/parsers/parsers.mhd.js';
import ParsersNifti from 'ami.js/src/parsers/parsers.nifti.js';
          ...
          () => {
            resolve(new Promise((resolve, reject) => {
              ...
              try {
                ...
                this._volumeParser = volumeParser;
                window.parser = volumeParser;
              } catch (e) {
